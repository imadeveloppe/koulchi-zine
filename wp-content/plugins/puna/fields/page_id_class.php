...
class Ravis_booking_page_class_meta_box
{
    ...
    function __construct()
    {
        ...
        $this->page_class_meta_fields = array(
            array(
                'label' => esc_html__('Page ID','puna' ),
                'desc'  => __('Add your custom ID for using it to change the default style. List of the default page IDs are <a href="#" target="_blank">here</a>', 'puna'),
                'id'    => $prefix.'id',
                'type'  => 'text',
            ),
            array(
                'label' => esc_html__('Page Class','puna' ),
                'desc'  => __('Add your custom class for using it to change the default style. List of the default page classes are <a href="#" target="_blank">here</a>', 'puna'),
                'id'    => $prefix.'class',
                'type'  => 'text',
            ),
            array(
                'label' => esc_html__('Page Breadcrumb Background','puna' ),
                'name'  => 'Image',
                'desc'  => esc_html__('Upload your desired image as page\'s breadcrumb.','puna' ),
                            ...
                            case 'image':
                                ...
                                echo    '
                                    <div class="img_uploader_post_meta">
                                        ...
                                        <input class="custom_upload_image_button button" type="button" value="'.esc_html__('Choose Image', 'puna').'" />
                                        <small> <a href="#" class="custom_clear_image_button button button-primary">'.esc_html__('Remove Image', 'puna').'</a></small>
