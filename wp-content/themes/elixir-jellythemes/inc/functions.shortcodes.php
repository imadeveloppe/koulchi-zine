		...
		function jellythemes_photos_list($atts, $content=null) {
		    ...
		    $return = '<div class="portfolio">';
		                ...
		                while ($photos->have_posts()) : $photos->the_post();
                    		...
                    		endforeach; 
                    		$description = '';
                    		if( get_field('description') ) $description = '<p>'.get_field('description').'</p>';
                            ...
                            $return .= '<article class="' . implode(' ', get_post_class('entry')) . '">
                            				<div>
				                                ...
				                                <div>
					                                <h3>'.get_the_title().'</h3>
					                                <img src="http://saporitaliani.net/wp-content/themes/elixir-jellythemes/images/spacer-desc-pizza.png" width="30">
					                                '.$description.'
				                                <div>
			                                </div>
			                            </article>';
