...
function jellythemes_photos()  {
  $labels = array(
    'name' => __('Galerie', 'framework'),
    'singular_name' => __('Photo', 'framework'),
    'add_new' => __('Ajouter photo', 'framework'),
    'add_new_item' => __('Ajouter photo', 'framework'),
    'edit_item' => __('Modifier photo', 'framework'),
    'new_item' => __('Nouvelle photo', 'framework'),
    'view_item' => __('Voir photos', 'framework'),
    'search_items' => __('Recherche photos', 'framework'),
    'not_found' =>  __('Aucune photo trouvé', 'framework'),
    'not_found_in_trash' => __('Aucune photo trouvé dans la corbeille', 'framework'),
    'parent_item_colon' => ''
  );
