    ...
    <head>
        ...
        <style type="text/css">
            ...
            .gallerieHome .portfolio > article > div > div { 
                display: none;
            }
        </style>
    </head>
    <body <?php body_class($jellythemes['color']); ?>  > 
        ...
        <!-- BEGIN HEADER -->
        <header id="header" role="banner" <?php echo "id_".the_ID(); ?>>
            <div class="jt_row container">
                ...
                <?php wp_nav_menu(array('container' => 'nav', 'menu_class' => 'nav navbar-nav navigation','menu_id' => 'nav', 'container_class' => 'collapse navbar-collapse navbar-right navbar-main-collapse', 'theme_location' => 'main', 'menu' => 'Main Menu', 'walker' => new jellythemes_walker_nav_menu)); ?>
