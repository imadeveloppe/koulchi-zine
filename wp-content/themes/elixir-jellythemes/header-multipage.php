...
<body <?php body_class($jellythemes['color'] . ' single-section'); ?>>
    ...
    <header id="header" role="banner">
        <div class="jt_row container">
            ...
            <?php wp_nav_menu(array('container' => 'nav', 'menu_class' => 'nav navbar-nav navigation','menu_id' => 'nav', 'container_class' => 'collapse navbar-collapse navbar-right navbar-main-collapse', 'theme_location' => 'main', 'menu' => "menu_multipage", 'walker' => new jellythemes_walker_nav_menu)); ?>  
            <!-- EN NAVIGATION MENU -->
            <ul class="lang-flag"><?php do_action('wpml_add_language_selector'); ?></ul>
