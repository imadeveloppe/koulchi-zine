	...
	class Ravis_recent_post_thumb extends WP_Widget
	{
		...
		function __construct()
		{
			parent::__construct(
				...
				esc_html__('Ravis Recent Post', 'puna'), // Name
				array('description' => esc_html__('Show the recent post with thumbnail.', 'puna'),) // Args
			);
		}
		...
		public function widget($args, $instance)
		{
			...
			if ($recent_posts) {
				echo '<div class="widget-content recent-posts"><ul>';
		...
		{
			$title    = !empty($instance['title']) ? $instance['title'] : esc_html__('New title', 'puna');
			...
			<p>
				<label
					for="<?php echo esc_attr($this->get_field_id('post_num')); ?>"><?php esc_html_e('Post Count:', 'puna'); ?></label>
