<?php
    ...
    if ( ! class_exists( 'ReduxFrameworkInstances' ) ) {
        // Instance Container
        require_once PUNA_FRAMEWORK . 'core/inc/class.redux_instances.php';
        require_once PUNA_FRAMEWORK . 'core/inc/lib.redux_instances.php';
    }
    ...
    if ( ! class_exists( 'ReduxFramework' ) ) {
        ...
        // Redux CDN class
        require_once PUNA_FRAMEWORK . 'core/inc/class.redux_cdn.php';

        // Redux API class  :)
        require_once PUNA_FRAMEWORK . 'core/inc/class.redux_api.php';

        // General helper functions
        require_once PUNA_FRAMEWORK . 'core/inc/class.redux_helpers.php';

        // General functions
        require_once PUNA_FRAMEWORK . 'core/inc/class.redux_functions.php';
        require_once PUNA_FRAMEWORK . 'core/inc/class.p.php';

        require_once PUNA_FRAMEWORK . 'core/inc/class.thirdparty.fixes.php';

        require_once PUNA_FRAMEWORK . 'core/inc/class.redux_filesystem.php';

        require_once PUNA_FRAMEWORK . 'core/inc/class.redux_admin_notices.php';
        ...
        class ReduxFramework {
            ...
            public static function init() {
                $dir = Redux_Helpers::cleanFilePath( PUNA_FRAMEWORK . 'core/' );
            ...
            public function __construct( $sections = array(), $args = array(), $extra_tabs = array() ) {
                ...
                if ( ! empty ( $this->args['opt_name'] ) ) {
                    ...
                    if ( $this->args['dev_mode'] == true || Redux_Helpers::isLocalHost() == true ) {
                        require_once PUNA_FRAMEWORK . 'core/core/dashboard.php';
                        new reduxDashboardWidget( $this );

                        if ( ! isset ( $GLOBALS['redux_notice_check'] ) ) {
                            require_once PUNA_FRAMEWORK . 'core/core/newsflash.php';
...
//                    wp_deregister_script( 'wpb_ace' );
            ...
            private function _tracking() {
                if ( file_exists( PUNA_FRAMEWORK . 'core/inc/tracking.php' ) ) {
                    require_once PUNA_FRAMEWORK . 'core/inc/tracking.php';
            ...
            public function _enqueue() {
                require_once PUNA_FRAMEWORK . 'core/core/enqueue.php';
            ...
            private function _register_extensions() {
                $path    = PUNA_FRAMEWORK . 'core/inc/extensions/';
            ...
            public function ajax_save() {
                ...
                if ( isset( $return_array ) ) {
                    if ( $return_array['status'] == "success" ) {
                        require_once PUNA_FRAMEWORK . 'core/core/panel.php';
